...
public abstract class SneckoCoreRelic : SneckoRelic
{
    private const int CharacterCount = 3;

    public SneckoCoreRelic(RelicRarity rarity) : base(rarity)
    {
    ...
    public override async Task AfterCardChangedPiles(CardModel card, PileType oldPileType, AbstractModel? source)
    {
        ...
        if (pile != null && pile.Type == PileType.Deck && card is SneckoCard sneckoCard && sneckoCard.GiftFilter != null)
        {
